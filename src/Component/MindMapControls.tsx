        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                className="bg-gradient-to-r from-[#F05A5B] to-[#BF4E30] hover:from-[#E04A4B] hover:to-[#AF3E20] text-white whitespace-nowrap"
              >
                Add
              </Button>
            </div>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <div className="text-xs text-gray-500 mb-1">Root Nodes</div>
